...
public:
    ...
    Scalar getMasterGroupInjectionRate(const std::string &group_name, const int phase_pos, const bool res_rates) const;
    Scalar getMasterGroupProductionRate(const std::string &group_name, const int phase_pos, const bool res_rates) const;
