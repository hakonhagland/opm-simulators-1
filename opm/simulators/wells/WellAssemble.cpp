...
void
WellAssemble<FluidSystem>::
assembleControlEqProd(const WellGroupHelperType& wgHelper,
                      ...
                      DeferredLogger& deferred_logger) const
{
    ...
    case Well::ProducerCMode::GRUP: {
        ...
        const auto& group = wgHelper.schedule().getGroup(well_.wellEcl().groupName(), well_.currentStep());
...
void
WellAssemble<FluidSystem>::
assembleControlEqInj(const WellGroupHelperType& wgHelper,
...
assembleControlEqProd<__VA_ARGS__>(const WellGroupHelper<typename A::Scalar, typename A::IndexTraitsType>&, \
...
template void WellAssemble<A>::                                           \
assembleControlEqInj<__VA_ARGS__>(const WellGroupHelper<typename A::Scalar, typename A::IndexTraitsType>&,   \
