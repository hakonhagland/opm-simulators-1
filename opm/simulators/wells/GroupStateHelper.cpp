                                                                            ...
                                                                            const bool is_injector) const
{
    ...
    if (this->isReservoirCouplingMaster()) {
        return this->reservoirCouplingMaster().getGroupRate(group.name(), phase_pos, res_rates, is_injector);
    }
    else {
        return 0.0;
    }
...
template <typename Scalar, typename IndexTraits>
bool
GroupStateHelper<Scalar, IndexTraits>::isReservoirCouplingMasterGroup_(const Group& group) const
{
#ifdef RESERVOIR_COUPLING_ENABLED
    if (this->isReservoirCouplingMaster()) {
