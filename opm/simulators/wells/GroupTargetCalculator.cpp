...
// Calculates a group target for a group with control FLD or control NONE. The group is assumed to
...
calculateGroupTarget()
{
    ...
    // NOTE: Use std::get<ControlMode> to strip away the std::monostate from the toplevel_control_mode_
    //   below.
